...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if($mysubject=='dmbi'){
      $sql = "SELECT id FROM coco WHERE subject='$mysubject' and name = '$myusername' and password = '$mypassword'";
      ...
      if($count == 1) {
         ...
         header("location:adtechdmbi.php");
      }else {
...
<tr>
<td colspan="3" align="center"><font size="5" ><strong>Course Coordinator Login </strong></font></td>
</tr>
...
</tr><tr><td><?php include("footer.php")?></td></tr>
</table>
</body>
</html>
