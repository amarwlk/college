...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $mysubject = mysqli_real_escape_string($db,$_POST['subject']); 
				...
				$sql = "SELECT id FROM sd WHERE name = '$myusername' and password = '$mypassword' union SELECT id FROM sse WHERE name = '$myusername' and password = '$mypassword' union SELECT id FROM sait WHERE name = '$myusername' and password = '$mypassword'";
...
<tr>
<td colspan="3" align="center"><font size="5" ><strong>Student Login </strong></font></td>
</tr>
