...
$status = FALSE;
if ( authorize($_SESSION["access"]["FRM"]["STUD"]["create"]) || 
authorize($_SESSION["access"]["FRM"]["STUD"]["edit"]) || 
authorize($_SESSION["access"]["FRM"]["STUD"]["view"]) || 
authorize($_SESSION["access"]["FRM"]["STUD"]["delete"]) ) {
 $status = TRUE;
}
...
<div class="row">
    <div class="col-lg-9">
        ...
        <?php if (authorize($_SESSION["access"]["FRM"]["STUD"]["create"])) { ?>
